        ...
        <tr>
            <td align="center" style="padding:30px 15px;">
                <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="background-color:#ffffff; border-radius:18px; overflow:hidden; box-shadow:0 20px 60px rgba(31,41,55,0.12);">
                    <tr>
                        <td style="background:linear-gradient(135deg,#dc2626,#991b1b); padding:35px 30px; color:#ffffff; text-align:center;">
                            <h1 style="margin:0; font-size:28px; letter-spacing:0.5px;">Payment Cancelled</h1>
                    ...
                    <tr>
                        <td style="padding:32px 30px 10px;">
                            ...
                            <p style="font-size:16px; color:#4b5563; margin:0 0 24px; line-height:1.7;">
                                We are writing to inform you that your payment for booking #{{ $booking->booking_number }} has been cancelled by our administration team.
                            </p>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <td style="background-color:#f8fafc; border-radius:14px; padding:24px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" style="font-size:16px; color:#374151;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:6px 0;"><strong style="font-size:20px;">₱{{ number_format($payment->amount, 2) }}</strong></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:6px 0;"><strong style="color:#dc2626;">Cancelled</strong></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="padding:0 30px 30px;">
                            <div style="background-color:#fef2f2; border:1px solid #fecaca; border-radius:14px; padding:20px;">
                                <h4 style="margin:0 0 12px; color:#991b1b; font-size:18px;">Important Notice</h4>
                                <p style="margin:0; color:#991b1b; font-size:16px; line-height:1.7;">
                                    Your booking may be affected by this payment cancellation. Please contact our support team if you have any questions or if you would like to make alternative payment arrangements.
                                </p>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 30px 40px; text-align:center; border-top:1px solid #f3f4f6;">
                            <p style="margin:20px 0 6px; font-size:16px; color:#6b7280;">Thank you for your understanding.</p>
