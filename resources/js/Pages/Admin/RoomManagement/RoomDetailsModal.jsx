                ...
                <div className="grid gap-6 py-4">
                    ...
                    <div className="p-4 border rounded-lg">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ₱
                                    {parseFloat(room.room_type?.price).toFixed(
                                        2
                                    )}{" "}
                                    / night
                                </p>
                            ...
                            <div>
                                <Label
                                    htmlFor="room-capacity-children"
                                    className="flex items-center gap-1"
                                >
                                ...
                                <p
                                    id="room-capacity-children"
                                    className="font-medium text-sm"
                                >
                                    {room.room_type?.capacity_children}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {room.room_type && (
                        <div className="p-4 border rounded-lg">
                            ...
                            <div className="mt-4">
                                <Label htmlFor="room-type-amenities">
                                    Amenities
                                </Label>
                                <p
                                    ...
                                    className="font-medium text-sm"
                                >
                                    {room.room_type?.amenities || "N/A"}
                                </p>
                            </div>
                            {room.room_type?.image_url && (
                                <div className="mt-4">
                                    <Label htmlFor="room-type-image">
                                        Image
                                    </Label>
                                    <img
                    ...
                    {room.current_booking && (
                        <div className="p-4 border rounded-lg">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <Label htmlFor="current-booking-id">
                                        Booking ID
                                    </Label>
                                    <p
                                        ...
                                        className="font-medium text-sm"
                                    >
                                        {room.current_booking.booking_number}
                                    </p>
                                </div>
                                <div>
                                    <Label htmlFor="current-booking-guest">
                                        Guest
                                    </Label>
                                    <p
                                        id="current-booking-guest"
                                        className="font-medium text-sm"
                                    >
                                        {
                                            room.current_booking.customer
                                                ?.first_name
                                        }{" "}
                                        {
                                            room.current_booking.customer
                                ...
                                <div>
                                    <Label htmlFor="current-check-in">
                                        Check-in
                                    </Label>
                                    <p
                                        id="current-check-in"
                                    ...
                                    >
                                        {new Date(
                                            room.current_booking.check_in_date
                                        ).toLocaleDateString()}
                                    </p>
                                </div>
                                <div>
                                    <Label htmlFor="current-check-out">
                                        Check-out
                                    </Label>
                                    <p
                                        id="current-check-out"
                                        className="font-medium text-sm"
                                    >
                                        {new Date(
                                            room.current_booking.check_out_date
                                        ).toLocaleDateString()}
                                    </p>
                                </div>
                            </div>
