            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Manage customer information and their linked accounts.</p>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        {/* Assuming Add New Guest button is still desired, though its implementation is not part of this task */}
                    ...
                    <table className="w-full text-sm text-left text-gray-600">
                        <thead className="bg-gray-50/80 text-xs text-gray-700 uppercase tracking-wider">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-4">Account Type</th>
                            ...
                            {filteredCustomers.length > 0 ? (
                                filteredCustomers.map((customer) => (
                                    <tr key={customer.id} className="hover:bg-gray-50 transition">
                                        <td className="px-6 py-4 font-mono text-blue-600">{customer.id}</td>
                                        <td className="px-6 py-4 font-semibold text-gray-800">{customer.first_name} {customer.last_name}</td>
                                        ...
                                        <td className="px-6 py-4">
                                            {customer.user_id ? (
                                                <span className="px-2.5 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">User Account</span>
                                            ) : (
                                                <span className="px-2.5 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">Guest</span>
                                            )}
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                            <div className="flex items-center justify-center gap-2">
                                                ...
                                                <button className="p-2 text-red-500 hover:bg-red-50 rounded-md transition" title="Delete Customer">
