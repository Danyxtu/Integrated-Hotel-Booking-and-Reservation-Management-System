                                ...
                                <div className="space-y-2 mt-4">
                                    ...
                                    {refundReason.length === 0 && (
                                        <p className="text-red-500 text-sm">
                                            Reason is required to proceed with
                                            refund.
                                        </p>
                                    )}
                                </div>
...
const AllPayments = ({ payments, statuses, sortBy, sortDirection }) => {
    ...
    const [selectedStatusFilter, setSelectedStatusFilter] = useState(
        currentParams.status_filter || "All"
    );
    const [selectedMethodFilter, setSelectedMethodFilter] = useState(
        currentParams.method_filter || "All"
    );
                            ...
                            <tr>
                                ...
                                >
                                    <button
                                        ...
                                        className="flex items-center justify-center gap-1 uppercase"
                                    >
                                        Status
                                        {sortBy === "status" && (
                                            <ArrowUpDown
                                    ...
                                    >
                                        <div className="flex flex-col items-center justify-center">
                                            ...
                                            <p className="font-semibold">
                                                No payments found matching your
                                                criteria.
                                            </p>
                                        </div>
                                    </td>
