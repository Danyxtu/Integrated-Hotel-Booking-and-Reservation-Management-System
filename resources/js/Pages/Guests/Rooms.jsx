...
export default function Rooms({ auth, rooms, roomTypes, searchParams, laravelVersion, phpVersion }) {
    const { props } = usePage();
    ...
    const handleSearch = () => {
        router.get(route('customer.rooms'), {
            start_date: checkIn,
            end_date: checkOut,
            adults: adults,
            children: children,
    ...
    const handleBookNow = (room) => {
        ...
        setData({
            ...
            check_in_date: checkIn,
            check_out_date: checkOut,
            total_price: room.price * calculateNumberOfNights(checkIn, checkOut),
    ...
    return (
        <CustomerLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Available Rooms</h2>}
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <h3 className="text-2xl font-bold mb-6">Find Your Perfect Room</h3>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6 mb-8 border border-gray-200">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-end">
                                    ...
                                    >
                                        <Search className="w-4 h-4 mr-2" /> Search Rooms
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {rooms.map((room) => (
                                    <div key={room.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                        <img src={room.image_path} alt={room.name} className="w-full h-48 object-cover" />
                                        <div className="p-4">
                                            ...
                                            <div className="flex items-center justify-between mb-3">
                                                ...
                                                <p className="text-lg font-bold text-gray-900">${room.price}<span className="text-sm text-gray-500">/night</span></p>
                                            </div>
            ...
            <Modal show={showingBookingModal} onClose={closeBookingModal}>
                <form onSubmit={submitBooking} className="p-6">
                    <h2 className="text-lg font-medium text-gray-900 mb-4">Book Room: {roomToBook?.name}</h2>
