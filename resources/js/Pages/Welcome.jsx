                        ...
                        <div className="relative w-full max-w-7xl mx-auto px-6">
                            ...
                            <header className="flex items-center justify-between py-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h1 className="text-2xl font-bold text-amber-900 dark:text-amber-400">LuxStay</h1>
                                        <p className="text-xs text-amber-700 dark:text-amber-300">Premium Hotels</p>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col items-center justify-center text-center py-20">
                                ...
                                <p className="text-xl md:text-2xl text-amber-800 dark:text-gray-300 mb-12 max-w-2xl">
                                    Discover luxury accommodations worldwide. Book directly and save up to 30% on your next adventure.
                                </p>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-400">
                                Experience the difference of premium hotel booking
                            </p>
                        </div>
                        ...
                        <div className="grid gap-8 lg:grid-cols-3">
                            ...
                            <div className="group bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <p className="text-gray-700 dark:text-gray-300">
                                    Find a lower price? We'll match it and give you an additional 10% off your booking. No hidden fees, ever.
                                </p>
                            </div>
                            ...
                            <div className="group bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <p className="text-gray-700 dark:text-gray-300">
                                    Your data is protected with bank-level encryption. Book with confidence knowing your information is safe.
                                </p>
                            </div>
                            ...
                            <div className="group bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <p className="text-gray-700 dark:text-gray-300">
                                    Our dedicated team is always ready to help you. Get assistance anytime, anywhere during your journey.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-24">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                {[
                                    { name: 'Paris', hotels: '156 Hotels', image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=400' },
                                    { name: 'Tokyo', hotels: '203 Hotels', image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400' },
                                    { name: 'New York', hotels: '312 Hotels', image: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=400' },
                                    { name: 'Bali', hotels: '128 Hotels', image: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400' },
                                ].map((dest, i) => (
                                    <div key={i} className="group relative overflow-hidden rounded-xl shadow-lg cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                                            ...
                                            <p className="text-amber-300">{dest.hotels}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
